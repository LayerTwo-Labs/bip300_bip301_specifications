...
```
WITHDRAWAL_BUNDLE_MAX_AGE = USED_SIDECHAIN_PROPOSAL_MAX_AGE
WITHDRAWAL_BUNDLE_INCLUSION_THRESHOLD = WITHDRAWAL_BUNDLE_MAX_AGE / 2 = 13_150

USED_SIDECHAIN_PROPOSAL_MAX_AGE = WITHDRAWAL_BUNDLE_MAX_AGE = USED_SIDECHAIN_PROPOSAL_MAX_AGE
USED_SIDECHAIN_SLOT_ACTIVATION_THRESHOLD = WITHDRAWAL_BUNDLE_INCLUSION_THRESHOLD = 13_150

UNUSED_SIDECHAIN_PROPOSAL_MAX_AGE = 2016
UNUSED_SIDECHAIN_SLOT_ACTIVATION_MAX_FAILS = 201
UNUSED_SIDECHAIN_SLOT_ACTIVATION_THRESHOLD = UNUSED_SIDECHAIN_PROPOSAL_MAX_AGE - UNUSED_SIDECHAIN_SLOT_ACTIVATION_MAX_FAILS = 1815
```
...
* The sidechain proposal refers to an unused slot, and the sidechain proposal
  age is greater than `UNUSED_SIDECHAIN_PROPOSAL_MAX_AGE` blocks
...
* The sidechain proposal refers to a used slot, and the sidechain proposal age
  is greater than `USED_SIDECHAIN_PROPOSAL_MAX_AGE` blocks
...
A transaction MUST be considered invalid if ... .
A transaction MUST be considered valid if ... .

## Block Validation Rules specification

A block MUST be considered invalid if ... .
A block MUST be considered valid if ... .
